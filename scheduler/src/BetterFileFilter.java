...
public class BetterFileFilter extends FileFilter {
    ...
    private Hashtable<String, BetterFileFilter> filters = null;
	...
	this.filters = new Hashtable<String, BetterFileFilter>(filters.length);
	...
	if(filters == null) {
	    filters = new Hashtable<String, BetterFileFilter>(5);
	}
     ...
     * @see BetterFileFilter#getDescription
     */
